...
9 -    for each edge(U, num_nodes): c=cost of edge(U,num_nodes) // for num_nodes in graph[U]
10 -     if num_nodes explored:
11 -       go to next num_nodes in line 9
12 -     total_cost = cost + c
13 -     add (total_cost,num_nodes) to H
